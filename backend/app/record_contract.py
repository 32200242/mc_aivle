...
SESSION_CONTENT_FIELD = "상담내용(상담개입)"
SESSION_CONTENT_FIELD_MAX_LENGTH = 700


def official_record_field_max_length(field: str) -> int:
    return SESSION_CONTENT_FIELD_MAX_LENGTH if field == SESSION_CONTENT_FIELD else OFFICIAL_RECORD_FIELD_MAX_LENGTH
