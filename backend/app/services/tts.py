...
EMOTION_STYLE = {
    ...
    "hurt": (
        "기본 음색·음역·나이·말투는 평소 목소리 그대로 유지한다. 처음에는 차분하게 말하고, "
        "좌절이나 단절을 설명하는 전환부터 억양만 조금씩 가라앉힌다. '서운하고 지쳐요'처럼 "
        "감정을 직접 말하는 구절에서는 말끝의 힘만 살짝 빠지게 한다. 새로운 슬픈 목소리를 "
        "연기하거나 처음부터 울먹이지 말고 상처받은 마음을 절제해서"
    ),
