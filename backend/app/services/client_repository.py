...
from ..questionnaire import (
    ...
    canonical_questionnaire_item_id,
    canonical_questionnaire_section,
    response_label,
)
from ..schemas import (
    AssessmentScore,
...
def get_client_case(client_id: str) -> ClientCase | None:
    ...
    return ClientCase(
        ...
        questionnaire_responses=[
            QuestionnaireResponse(
                item_id=canonical_questionnaire_item_id(str(row["item_id"])),
                section=canonical_questionnaire_section(str(row["section"])), domain=str(row["domain"]),
