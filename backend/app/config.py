...
class Settings:
    ...
    internal_tts_api_key: str = os.getenv("INTERNAL_TTS_API_KEY", "")
    tts_request_timeout: float = float(os.getenv("TTS_REQUEST_TIMEOUT", "180"))
    avatar_provider: str = os.getenv("AVATAR_PROVIDER", "static_2d")
    longcat_avatar_base_url: str = os.getenv("LONGCAT_AVATAR_BASE_URL", "").rstrip("/")
    longcat_avatar_api_key: str = os.getenv("LONGCAT_AVATAR_API_KEY", "")
    longcat_avatar_request_timeout: float = float(os.getenv("LONGCAT_AVATAR_REQUEST_TIMEOUT", "1800"))
    ocr_provider: str = os.getenv("OCR_PROVIDER", "paddleocr_vl_http")
    internal_ocr_url: str = os.getenv("INTERNAL_OCR_URL", "").rstrip("/")
    internal_ocr_api_key: str = os.getenv("INTERNAL_OCR_API_KEY", "")
    ocr_request_timeout: float = float(os.getenv("OCR_REQUEST_TIMEOUT", "300"))
    ocr_health_timeout: float = float(os.getenv("OCR_HEALTH_TIMEOUT", "12"))
    ocr_remote_batch_size: int = int(os.getenv("OCR_REMOTE_BATCH_SIZE", "4"))
    paddle_ocr_model_id: str = os.getenv("PADDLE_OCR_MODEL_ID", "PaddlePaddle/PaddleOCR-VL-1.6")
    paddle_ocr_max_new_tokens: int = int(os.getenv("PADDLE_OCR_MAX_NEW_TOKENS", "512"))
    ...
    stt_health_timeout: float = float(os.getenv("STT_HEALTH_TIMEOUT", "8"))
    ...
    llm_max_output_tokens: int = int(os.getenv("LLM_MAX_OUTPUT_TOKENS", "1600"))
