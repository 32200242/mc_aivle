...
CLIENT_CASES = [
    ClientCase(
        ...
        assessments=[
            _assessment("FRPSS", "가족관계문제징후척도", 47, 90, "확인 기준 미만", "18문항 원점수 합계이며 확인 기준은 54점 이상임"),
    ...
    ClientCase(
        ...
        assessments=[
            _assessment("FRPSS", "가족관계문제징후척도", 52, 90, "확인 기준 미만", "18문항 원점수 합계이며 확인 기준은 54점 이상임"),
    ...
    ClientCase(
        ...
        assessments=[
            _assessment("FRPSS", "가족관계문제징후척도", 42, 90, "확인 기준 미만", "18문항 원점수 합계이며 확인 기준은 54점 이상임"),
    ...
    ClientCase(
        ...
        assessments=[
            _assessment("FRPSS", "가족관계문제징후척도", 49, 90, "확인 기준 미만", "18문항 원점수 합계이며 확인 기준은 54점 이상임"),
