...
export const HWANG_OCR_REVIEW_NOTE = "부부 갈등 내용과 신체적 폭력·위협 관련 부정문을 첨부한 SOAP 노트와 문장 단위로 확인함";
  ...
  module_analyses: [
    {
      id: "intake_pattern",
      title: "사전문진 통합",
      frameworks: ["FRPSS", "FSTRESS", "관계 해체 고려 문항"],
      evidence_level: "누적기록 기반",
      summary: "관계 부담과 생활사건 부담을 진단값이 아닌 면담 우선순위로 함께 검토합니다.",
      evidence: ["가족관계문제징후척도 47/90 · 확인 기준 54", "생활사건 경험빈도·부담 합계 분리 확인", "관계 해체 고려 문항 1/3"],
...
export function buildHwangRecords(serviceDate: string, counselorName: string): IntegratedRecords {
  return {
    ...
    session_record: {
      ...
      "상담주제 2순위": "갈등 후 복구 대화",
      "상담주제 3순위": "감정과 요청 표현",
      "당회기 상담목표": "생활비와 육아 분담 갈등에서 나타나는 비난-방어 순환을 두 사람이 함께 알아차리고 중단 신호를 합의한다.\n상대를 평가하거나 책임을 묻는 표현 대신 자신의 감정·욕구·구체적 요청을 한 문장으로 전달하고, 상대의 말을 끊지 않고 요약해 확인하는 복구 대화를 연습한다.\n갈등이 고조되면 20분 동안 대화를 멈춘 뒤 약속한 시각에 다시 시작하는 절차까지 정한다.",
      "상담내용(상담개입)": "회기 초반 최근 생활비 지출과 육아 분담을 논의하다 언성이 높아졌던 장면을 선정하고, 대화가 시작된 계기부터 각자의 말과 행동, 감정 변화, 대화가 끝난 결과까지 시간 순서로 재구성하였다. 남편이 부담과 불만을 지적하면 배우자가 해명하거나 반박하고 남편의 지적이 더 강해지는 비난-방어 순환이 반복됨을 도식화해 두 사람이 함께 확인하였다.\n상담자는 사실·해석·감정·욕구를 구분하도록 질문하고, 상대를 평가하거나 책임을 묻는 표현을 ‘나는 …해서 …하게 느끼며, …해주기를 바란다’는 감정-욕구-요청 문장으로 바꾸어 말하도록 개입하였다. 듣는 사람은 반박하기 전에 들은 내용을 한 문장으로 요약하고 상대에게 맞는지 확인하도록 하였다. 초반에는 서로 말을 끊고 시선을 피했으나 연습을 반복하면서 차례를 지켜 말하고 상대의 핵심 표현을 요약할 수 있었다.\n갈등이 고조될 때 사용할 중단 신호를 정하고, 중단은 대화를 회피하는 것이 아니라 감정을 낮춘 뒤 약속한 시각에 다시 시작하기 위한 절차임을 확인하였다. 과거 20분간 대화를 멈춘 뒤 재개했을 때 언성이 낮아졌던 경험을 복구 자원으로 연결했으며, 실제 갈등에서도 같은 절차를 적용하기로 하였다. 회기 말 신체적 폭력·위협·강압 여부를 확인했고 두 사람은 없었다고 보고하였다.",
      "다음 회기 계획": "다음 회기에는 두 사람이 합의한 대화 중단 신호를 실제 갈등 장면에서 사용했는지, 중단 후 20분 이내에 약속한 방식으로 대화를 다시 시작했는지 각각 확인한다.\n재개한 대화에서 감정-욕구-요청 문장을 사용한 횟수와 상대의 말을 요약해 확인했을 때 달라진 반응을 구체적으로 점검한다.\n이후 생활비 지출 기준과 평일·주말 육아 역할을 항목별로 나누어 각자의 기대와 가능한 범위를 말하고, 서로 수용할 수 있는 한 가지 실행 합의를 정하도록 돕는다.",
      "연계기관": "현재 연계 없음",
    },
    soap: {
    ...
    source_summary: {
      "상담 메모": "2회기 상담 내용 반영",
      "SOAP 노트": "첨부한 수기 노트 반영",
      "원본 확인": "S/O/A/P 항목별 내용 확인 완료",
      "확인 메모": HWANG_OCR_REVIEW_NOTE,
      "사례 기본정보": "황재훈 사례 연결",
      "이전 상담기록": "1회기 확정기록 반영",
    },
  };
